...
from tokenclaw.crunch import build_embedding, crunch_body, estimate_tokens_from_text
...
from tokenclaw.provider_adoption import capture_provider_tool_adoption, openai_stream_tool_use_ids
from tokenclaw.optimization.openai_features import (
    openai_call_store_fields,
)
from tokenclaw.optimization.openai_outcomes import (
    attach_openai_outcome_summary,
    record_managed_outcome_feedback,
)
from tokenclaw.optimization.openai_pipeline import (
