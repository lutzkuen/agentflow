...
from tokenclaw.pattern_rollout import PATTERN_ROLLOUT_SCHEMA, normalize_pattern_rollout
...
def _traffic_pattern_summaries(store_obj: Any, *, limit: int, since: str | None = None) -> tuple[list[dict[str, Any]], dict[str, Any]]:
    from tokenclaw.recommendations import pattern_decision_summaries
