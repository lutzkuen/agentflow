...
POLICY_RELOAD_MODULES = (
    ...
    "tokenclaw.crunch",
    "tokenclaw.cache",
    "tokenclaw.routing_experiments",
    "tokenclaw.codex_turn_policy",
    "tokenclaw.anthropic_proxy",
    "tokenclaw.openai_proxy",
    "tokenclaw.stats",
)
...
def create_admin_router(after_reload: Callable[[], None] | None = None) -> APIRouter:
    ...
    async def stage_policy_draft(request: Request) -> Any:
        ...
        from tokenclaw.policy_files import stage_policy_draft as stage_policy_draft_payload
