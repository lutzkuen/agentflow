...
from tokenclaw.cli_common import redact_secret as _redact_secret
from tokenclaw.cli_common import write_json as _write_json
...
def _managed_recommendation_summary(bundle: Any) -> dict[str, Any]:
    ...
    if codex_app:
        from tokenclaw.policy_bundle import codex_app_policy_review_summary
    ...
    if crunch or cache:
        from tokenclaw.policy_bundle import old_context_summary_policy_review_summary, pattern_policy_review_summary
...
def policy_fetch_review_cli(
    ...
    *,
    ...
    from tokenclaw.policy_bundle import build_policy_bundle, review_policy_bundle, validate_policy_bundle
    from tokenclaw.recommendation_health import strip_raw_payload_fields
...
def policy_apply_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.policy_bundle import apply_policy_bundle
...
def policy_draft_stage_cli(
    ...
    *,
    ...
    from tokenclaw.openai_optimization_drafts import (
        is_openai_optimization_review_payload,
        stage_openai_optimization_review_draft,
    )
    from tokenclaw.policy_events import log_policy_event
    from tokenclaw.policy_files import parse_policy_payload, stage_policy_draft
...
def managed_activation_bundle_stage_cli(
    ...
    *,
    ...
    from tokenclaw.policy_files import parse_policy_payload
    from tokenclaw.managed_activation_bundles import stage_managed_activation_bundle
    from tokenclaw.policy_events import log_policy_event
...
def policy_draft_apply_cli(
    ...
    *,
    ...
    if not args.allow_non_loopback and not _is_loopback_url(args.reload_url):
        from tokenclaw.policy_events import log_policy_event
        from tokenclaw.policy_workbench import POLICY_DRAFT_APPLY_SCHEMA
