...
def openai_optimization_draft_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.openai_optimization_draft_dry_run import dry_run_openai_optimization_draft
...
def openai_optimization_draft_apply_cli(
    ...
    *,
    ...
    from tokenclaw.openai_optimization_draft_apply import apply_openai_optimization_draft
    from tokenclaw.store import Store
...
def codex_app_policy_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.codex_app_dry_run import dry_run_codex_app_policy, load_codex_app_fixture_features
...
def managed_rollout_actions_review_cli(
    ...
    *,
    ...
    if isinstance(bundle, dict) and bundle.get("schema") == "agentflow.openai_cache_replay_rollout_actions.v1":
        ...
        from tokenclaw.rollout_actions import plan_rollout_actions
...
def optimization_rollout_actions_review_cli(
    ...
    *,
    ...
    from tokenclaw.optimization_rollout_review import review_optimization_rollout_actions
    from tokenclaw.policy_events import log_policy_event
...
def optimization_rollout_actions_apply_cli(
    ...
    *,
    ...
    from tokenclaw.optimization_promotion_canary import apply_optimization_promotion_canaries
...
def scaffold_rollout_actions_review_cli(
    ...
    *,
    ...
    from tokenclaw.policy_events import log_policy_event
    from tokenclaw.scaffold_rollout_review import review_scaffold_rollout_actions
...
def scaffold_rollout_actions_apply_cli(
    ...
    *,
    ...
    from tokenclaw.policy_events import log_policy_event
    from tokenclaw.scaffold_rollout_review import apply_scaffold_rollout_actions
    ...
    *,
    ...
    if read_error:
        ...
        if isinstance(bundle, dict) and bundle.get("schema") == "agentflow.openai_cache_replay_rollout_actions.v1":
            ...
            from tokenclaw.rollout_actions import apply_rollout_actions
    ...
    *,
    ...
    if read_error:
        ...
        if isinstance(bundle, dict) and bundle.get("schema") == "agentflow.openai_cache_replay_rollout_actions.v1":
            ...
            from tokenclaw.rollout_actions import dry_run_rollout_actions
...
def old_context_summary_impact_cli(
    ...
    *,
    ...
    if read_error:
        from tokenclaw.old_context_summary_impact import OLD_CONTEXT_SUMMARY_IMPACT_SCHEMA
        ...
        from tokenclaw.old_context_summary_impact import measure_old_context_summary_impact
...
def old_context_summary_quality_gate_cli(
    ...
    *,
    ...
    report, read_error, _stdin_used = _read_policy_json_arg(args.path, stdin=stdin, stdin_used=False)
    if read_error:
        from tokenclaw.old_context_summary_impact import OLD_CONTEXT_SUMMARY_QUALITY_GATE_SCHEMA
        ...
        from tokenclaw.old_context_summary_impact import build_old_context_summary_quality_gate
...
def old_context_summary_rollout_actions_review_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.old_context_summary_rollout_actions import plan_summary_rollout_actions
...
def old_context_summary_rollout_actions_apply_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.old_context_summary_rollout_actions import apply_summary_rollout_actions
...
def old_context_summary_rollout_actions_dry_run_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.old_context_summary_rollout_actions import dry_run_summary_rollout_actions
...
def old_context_summary_rollout_actions_impact_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.old_context_summary_rollout_actions import measure_summary_rollout_action_impact
...
def managed_rollout_actions_impact_cli(
    ...
    *,
    ...
    if read_error:
        ...
        from tokenclaw.rollout_actions import measure_rollout_action_impact
...
def codex_diagnose_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.stats import stats_codex_effectiveness
...
def codex_canary_impact_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.stats import stats_codex_canary_impact
...
def openai_scoreboard_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    from tokenclaw.optimization.scoreboard import openai_scoreboard_cli as _openai_scoreboard_cli
...
def routing_coverage_report_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=5000,
        help="Recent provider calls and Codex app events to inspect, default: 5000, max: 25000",
    )
    parser.add_argument(
        "--pretty",
        action="store_true",
    ...
    store = open_store_for_db(str(args.db))
    try:
        result = build_routing_coverage_report(store, limit=args.limit)
    finally:
        store.conn.close()
    if args.pretty:
        stdout.write(json.dumps(result, indent=2, sort_keys=True) + "\n")
...
def openai_routing_canary_stage_cli(
    ...
    *,
    ...
    if args.promotion_blocker_review:
        ...
        from tokenclaw.orchestrator_research import _pass_through_routing_report
    ...
    from tokenclaw.openai_routing_canary_stage import stage_openai_routing_canary_drafts
    from tokenclaw.policy_events import log_policy_event
    ...
    if args.queue_feedback:
        from tokenclaw.activation_lifecycle_feedback import queue_activation_staged_lifecycle_feedback
    ...
    *,
    ...
    if args.routing_report:
        ...
        if args.managed_preview_outcomes:
            ...
            from tokenclaw.managed_activation_preview_outcomes import build_managed_activation_preview_outcomes_report
        ...
        from tokenclaw.openai_routing_report import build_openai_routing_promotion_decision_report
        from tokenclaw.managed_activation_preview_outcomes import build_managed_activation_preview_outcomes_report
...
def anthropic_routing_safety_stop_unblock_drill_cli(argv: Sequence[str] | None = None, *, stdout: Any = None, stderr: Any = None) -> int:
    ...
    from tokenclaw.activation_lifecycle_feedback import SAFETY_STOP_BURNDOWN_SCHEMA, activation_safety_stop_burndown_report
    from tokenclaw.anthropic_routing_unblock_drill import build_anthropic_routing_safety_stop_unblock_drill
...
def optimization_action_ledger_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.optimization.cli_support import open_store_for_db, write_json
    from tokenclaw.optimization_action_ledger import build_optimization_action_ledger_report
...
def provider_tool_adoption_report_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    from tokenclaw.provider_adoption import provider_tool_adoption_report_cli as _provider_tool_adoption_report_cli
...
def instruction_dedup_impact_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    try:
        ...
        from tokenclaw.instruction_dedup_feedback import SOURCE_SURFACE as INSTRUCTION_DEDUP_LIFECYCLE_SOURCE_SURFACE
...
def anthropic_thinking_compaction_opportunity_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.anthropic_thinking_compaction_report import build_anthropic_thinking_compaction_opportunity_report
    from tokenclaw.optimization.cli_support import open_store_for_db, write_json
...
def anthropic_thinking_compaction_dry_run_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.anthropic_thinking_compaction_dry_run import build_anthropic_thinking_compaction_dry_run
    from tokenclaw.optimization.cli_support import open_store_for_db, write_json
...
def terminal_output_compaction_dry_run_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.optimization.cli_support import open_store_for_db, write_json
    from tokenclaw.terminal_compaction_dry_run import build_terminal_output_compaction_dry_run
...
def _attach_openai_cache_replay_lifecycle_feedback(result: dict[str, Any], *, db_path: str) -> None:
    from tokenclaw import recommendations
    from tokenclaw.openai_cache_replay_impact import build_openai_cache_replay_lifecycle_feedback
...
def local_promotion_candidates_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.local_promotion_candidates import build_local_promotion_candidates_report
...
def crunch_promotion_draft_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.crunch_promotion_drafts import dry_run_crunch_promotion_drafts
...
def cache_promotion_draft_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.cache_promotion_drafts import dry_run_cache_promotion_drafts
...
def routing_promotion_draft_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.routing_promotion_rule_drafts import dry_run_routing_promotion_drafts
...
def openai_cache_replay_apply_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.openai_cache_replay_apply import apply_openai_cache_replay_candidates
    from tokenclaw.policy_events import log_policy_event
...
def anthropic_routing_lifecycle_report_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.claude_canary_impact import build_anthropic_routing_canary_lifecycle_report
...
def claude_canary_actions_cli(
    ...
    *,
    ...
    from tokenclaw.claude_canary_actions import build_claude_canary_actions
...
def claude_canary_actions_apply_cli(
    ...
    *,
    ...
    from tokenclaw.claude_canary_actions import apply_claude_canary_actions
    from tokenclaw.policy_events import log_policy_event
...
def routing_canary_promote_cli(
    ...
    *,
    ...
    from tokenclaw.policy_events import log_policy_event
    from tokenclaw.routing_canary_promote import (
...
def routing_promotion_draft_stage_cli(
    ...
    *,
    ...
    from tokenclaw.policy_events import log_policy_event
    from tokenclaw.routing_promotion_drafts import stage_routing_promotion_drafts
...
def cache_replayability_report_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.stats import stats_cache_replayability
...
def request_shape_cache_replay_canary_stage_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.request_shape_rollups import build_request_shape_cache_replay_canary_stage_report
    ...
    try:
        ...
        store.conn.close()
    if args.apply:
        from tokenclaw.request_shape_rollups import apply_request_shape_cache_replay_canary_action
...
def request_shape_cache_replay_evidence_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.request_shape_rollups import build_request_shape_cache_replay_evidence_report
...
def request_shape_cache_replay_policy_decision_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=10000,
        help="Recent provider calls to inspect for cache replay evidence, default: 10000",
    )
    parser.add_argument(
        "--config-dir",
        default=os.getenv("AGENTFLOW_CONFIG_DIR") or os.getenv("AGENTFLOW_POLICY_CONFIG_DIR", str(Path.home() / ".agentflow")),
    ...
    result["source_evidence"] = {
        **result["source_evidence"],
        "source": {
            ...
            "rows_scanned": (evidence.get("source") or {}).get("rows_scanned")
            if isinstance(evidence.get("source"), dict)
            else None,
            "lookback_limit": (evidence.get("source") or {}).get("lookback_limit")
            if isinstance(evidence.get("source"), dict)
            else None,
        },
    }
...
def managed_recommendation_handoff_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.orchestrator_research import build_managed_recommendation_handoff_report
    from tokenclaw.request_shape_rollups import build_request_shape_rollups_report
...
def local_activation_outcome_summary_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    parser = argparse.ArgumentParser(
        description="Export aggregate local activation outcomes for optional feature-only managed optimizer handoff"
    )
    parser.add_argument(
        "--db",
        default=os.getenv("AGENTFLOW_DATABASE_URL") or os.getenv("AGENTFLOW_DB", str(Path.home() / ".agentflow" / "agentflow.sqlite3")),
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Recent provider calls to aggregate, default: 1000, max: 20000",
    )
    parser.add_argument(
        "--config-dir",
        default=os.getenv("AGENTFLOW_CONFIG_DIR") or os.getenv("AGENTFLOW_POLICY_CONFIG_DIR", str(Path.home() / ".agentflow")),
...
def cache_replay_cohorts_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.stats import stats_cache_replay_cohort_ranking
...
def cache_replay_dry_run_cli(
    ...
    *,
    ...
    from tokenclaw.stats import stats_cache_replay_dry_run
...
def phase_routing_report_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.phase_routing_report import (
...
def managed_pattern_rollups_cli(argv: Sequence[str] | None = None, *, stdout: Any = None) -> int:
    ...
    from tokenclaw.stats import stats_managed_pattern_rollups
...
def optimization_eval_queue_cli(
    ...
    *,
    ...
    if args.promotion_report:
        from tokenclaw.optimization_eval_queue import backfill_promotion_eval_tasks
    ...
    if args.promotion_blocker_review:
        from tokenclaw.optimization_eval_queue import queue_promotion_recommendation_eval_tasks
        from tokenclaw.promotion_blocker_review import build_promotion_blocker_recommendation_review
    ...
    from tokenclaw.optimization_eval_queue import run_optimization_eval_queue
...
def optimization_promotion_impact_cli(
    ...
    *,
    ...
    try:
        ...
        if result.get("ok") and not args.no_record_outcome_feedback:
            from tokenclaw.promotion_outcome_feedback import record_promotion_outcome_feedback
