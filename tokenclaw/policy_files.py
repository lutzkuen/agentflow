...
async def stage_policy_draft(
    ...
    *,
    ...
    from tokenclaw.policy_bundle import build_policy_bundle, compare_policy_bundles, validate_policy_bundle
    from tokenclaw.policy_bundle import _policy_apply_yaml  # local file renderer used by apply dry-runs
