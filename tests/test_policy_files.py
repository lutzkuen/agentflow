...
class PolicyFileStatusTest(unittest.TestCase):
    ...
    def test_policy_bundle_exports_effective_default_policy_state(self):
        ...
        self.assertFalse(openai_canary["enabled"])
        self.assertEqual(openai_canary["policy_id"], "local-openai-routing-retired")
        self.assertEqual(openai_canary["router_runtime_status"], "retired")
