...
from agentflow_proxy.policy_files import POLICY_DRAFT_STAGE_SCHEMA, stage_policy_draft
...
def _attach_local_draft_provenance_if_configured(bundle: dict[str, Any]) -> dict[str, Any]:
    from agentflow_proxy.policy_bundle import _verification_secrets, attach_policy_bundle_provenance
