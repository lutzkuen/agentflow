...
def _add_row(aggregate: dict[str, Any], row: dict[str, Any], canary: dict[str, Any]) -> None:
...
def _decide_verdict(
    *,
    ...
    return {"verdict": verdict, "reason_codes": reason_codes, "warning_codes": warning_codes}
